...
//画图啦**********************************************************************************************
	public void paintComponent (  Graphics page) 
	{
		...
		if(cishu==0)
		{
			if(p1.yangzi==7) {Music.stop();Music.music[8].loop();cishu=1;Mypanel.lay.show(Play.panel,"zhanwin");}
			if(p2.yangzi==7){Music.stop();cishu=1;Music.music[8].loop();Mypanel.lay.show(Play.panel,"baowin");}		
		}
