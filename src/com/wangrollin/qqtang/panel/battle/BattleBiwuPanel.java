package com.wangrollin.qqtang.panel.battle;

import com.wangrollin.qqtang.constants.GameConstants;
import com.wangrollin.qqtang.element.*;
import com.wangrollin.qqtang.panel.MyPanelCard;
import com.wangrollin.qqtang.player.BiwuModePlayer;
...
public class BattleBiwuPanel extends JPanel {
    ...
    private Timer timer;
    //地图
    //static com.wangrollin.qqtang.element.Maps maps;
    ...
    // battle com.wangrollin.qqtang.panel 整理 todo
    ...
    public BattleBiwuPanel(MyPanelCard myPanelCard, CardLayout cardLayout) {
        ...
        //MusicTool.Musicload();
        //maps = new com.wangrollin.qqtang.element.Maps();
        timeCounter = new TimeCounter();
        //p1 = new com.wangrollin.qqtang.player.BiwuModePlayer();
